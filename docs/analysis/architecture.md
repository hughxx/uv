...
更新：2026-09-14。状态：目标架构。已实现HTTP入口、盘面视图、回合去重、空间与联合动作校验及打包；候选调度、任务和Playbook仍待实现，技术选型和参数需按运行环境及回放验证。
...
已落地的提交骨架位于[CoreGeek](../../CoreGeek/main3.py)，启动、测试及打包见[仓库README](../../README.md)。它不代表P1的状态、回放、预算校验已经全部完成，当前策略仅返回空动作。
